#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/bootdevice/by-name/recovery:33554432:b4966bca69ca694b05d34bfabad3957b8905705b; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/bootdevice/by-name/boot:33554432:60e4d4eb5abd1b2d4464f591e68f877cee33769f \
          --target EMMC:/dev/block/platform/bootdevice/by-name/recovery:33554432:b4966bca69ca694b05d34bfabad3957b8905705b && \
